...
var style_Meat_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("KS_Meat an");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 0.376466) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.376466 && value <= 3.328490) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 3.328490 && value <= 8.422745) {
            style = [ new ol.style.Style({
